...
public class NetworkUtils {
	 ...
	 */
	public static ArrayList<StringTuple3> calcLeftSide(int i, ArrayList<StringTuple3> tuples) {
	 ...
	 * @return All member left from the actual position.
	 */
	public static ArrayList<StringTuple3> calcRightSide(int i, ArrayList<StringTuple3> tuples) {
	 ...
	 */
	public static ArrayList<StringTuple3> mergeNeighbors(ArrayList<StringTuple3> leftSide,
