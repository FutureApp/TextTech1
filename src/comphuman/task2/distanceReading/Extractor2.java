...
public class Extractor2 {
	...
	public String findCreationDate(String currContent) {
		...
		System.out.println("DATE - "+wordToReturn);
		return wordToReturn;
	}

	public String findUserName(String currContent) {
		String wordToReturn = extractName(currContent);
		System.out.println("USER - "+wordToReturn);
		return wordToReturn;
	}

	private String extractName(String currContent) {
		String user = "";
		System.out.println(currContent.lastIndexOf("title"));
		System.out.println(currContent.substring(currContent.lastIndexOf("title")));
